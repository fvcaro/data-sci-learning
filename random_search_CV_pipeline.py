...
param_dist = {
    ...
    'classifier__alpha': loguniform(1e-5, 1e0),  # Log-uniform distribution for alpha
}
...
# python random_search_CV_pipeline.py > random_search_CV_pipeline_$(date +%d-%m-%Y_%H.%M.%S).txt 2>&1 &
